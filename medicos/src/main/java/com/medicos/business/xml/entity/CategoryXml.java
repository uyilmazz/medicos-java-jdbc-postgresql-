...
public class CategoryXml {
	...
	public static Document formatAll(List<Category> categoryList) throws ParserConfigurationException {
		...
		for (int i = 0; i < categoryList.size(); i++) {
			...
			XmlHelper.addSingleElement(document, categoriesElement, "category", null, "id", Integer.toString(category.getId()));
	...
	public static void formatHelper(Document document,Element categoryElement,Category category) {
	...
	public static Category parseHelper(Element categoryElement) {
